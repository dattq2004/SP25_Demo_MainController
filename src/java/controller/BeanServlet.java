 ...
 * @author LAPTOP ASUS
 */
@WebServlet(name="BeanServlet", urlPatterns={"/bean"})
public class BeanServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("/product/addDemo.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        Product pNew = new Product(name, price, description, stock);
